class DuringLA < ApplicationRecord
    ...
    has_many :during_la_subjects

    has_attached_file :during_la_signed_student, :url=> "/erasmus/attachment/dm_student/:id/:basename.:extension"
    has_attached_file :during_la_signed_home, :url=> "/erasmus/attachment/dm_host/:id/:basename.:extension"
    ...
    validates_attachment_content_type :during_la_signed_home, :content_type => ["application/pdf", "application/doc", "application/docx", "image/jpeg", "image/gif", "image/png", "image/jpg", "image/bmp"]
    ...
    validates_attachment_size :during_la_signed_home, :less_than => 4.megabytes
    ...
    def clean_paperclip_errors
        ...
        errors.delete(:during_la_signed_home)
